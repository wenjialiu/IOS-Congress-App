...
class SenateTableViewController: UITableViewController, UISearchBarDelegate{
    ...
    func FirstView(){
        ...
        let leftButton = UIBarButtonItem(image: menu_img,  style:UIBarButtonItemStyle.plain, target: self, action: #selector(SenateTableViewController.backToMenu))
        self.navigationItem.leftBarButtonItem = leftButton
        
        let rightButton = UIBarButtonItem(image: search_img,  style:UIBarButtonItemStyle.plain, target: self, action: #selector(SenateTableViewController.createSearchBar))
    ...
    fileprivate func get_Data_From_Legi_URL(){
        ...
        Alamofire.request("http://sample-env-2.es472mesmq.us-west-1.elasticbeanstalk.com/index.php?q=senate")
