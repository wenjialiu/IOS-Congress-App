...
class NewBillTableViewController: UITableViewController, UITabBarControllerDelegate, UISearchBarDelegate{
    ...
    func FirstView(){
        ...
        let leftButton = UIBarButtonItem(image: menu_img,  style:UIBarButtonItemStyle.plain, target: self, action: #selector(NewBillTableViewController.backToMenu))
        
        self.navigationItem.leftBarButtonItem = leftButton
        
        let rightButton = UIBarButtonItem(image: search_img,  style:UIBarButtonItemStyle.plain, target: self, action: #selector(NewBillTableViewController.createSearchBar))
    ...
    func createSearchBar(){
        ...
        let rightButton = UIBarButtonItem(image: cancel_img,  style:UIBarButtonItemStyle.plain, target: self, action: #selector(NewBillTableViewController.viewWillAppear(_:)))
        self.navigationItem.rightBarButtonItem = rightButton
    ...
    fileprivate func get_Data_From_Legi_URL(){
        ...
        Alamofire.request("http://sample-env-2.es472mesmq.us-west-1.elasticbeanstalk.com/index.php?q=new_bill")
