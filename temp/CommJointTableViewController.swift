//
//  CommJointTableViewController.swift
//  temp
//
...
class CommJointTableViewController: UITableViewController, UITabBarControllerDelegate, UISearchBarDelegate{
    ...
    fileprivate func get_Data_From_Legi_URL(){
        ...
        Alamofire.request("http://sample-env-2.es472mesmq.us-west-1.elasticbeanstalk.com/index.php?q=comm_joint")
